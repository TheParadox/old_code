...
Controller.prototype = {
    ...
    drawTimelineBackground: function() {
        ...
        if (this.isAudio())
            ...
            ctx.fillStyle = getComputedStyle(document.body).getPropertyValue('--player-timeline-buffered-color');
        ...
        */
        ...
        /*if (this.isAudio())
            ...
            ctx.fillStyle = getComputedStyle(document.body).getPropertyValue('--player-timeline-played-color');
    ...
    drawVolumeBackground: function() {
        ...
        if (this.isVolumeSliderActive)
            ctx.fillStyle = getComputedStyle(document.body).getPropertyValue('--player-highlight-color');
        else
            ctx.fillStyle = getComputedStyle(document.body).getPropertyValue('--player-accent-color');
        ctx.fillRect(0, 0, width, height);
        ctx.restore();
